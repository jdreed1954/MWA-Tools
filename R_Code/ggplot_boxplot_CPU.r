#
# <ggplot_boxplot_CPU.r> - R script to create detailed graphs of CPU Box Plots of CPU Utilization and Memory.
#           
#
#                 > host
#                   [1] "hsgccu25" "hsgccu28" "hsgccu41" "hsgccu46" "hsgccu75" "hsgccu76" "hsgccu96"
#                 > SYSTEMS <- host
#                 > source('C:/Users/jxreed/Desktop/MyProjects/bin/ggplot_CPU.r')
#                   > SYSTEMS
...
myvars <- c("Epoch.DT","Int.Date", "CPU.User","CPU.Sys","CPU.Intrpt","CPU.SysCall","CPU.Tot","Mem.Pct", "MemSO.Rt")
...
for (i in SYSTEMS) {
  ...
  pdf_name <- paste(as.character(i),"_",as.Date(as.POSIXlt(enddate, origin = "1970-1-1", format = "%Y-%m-%d")),"_BOXP_CPU_",DAYS,"d.pdf", sep = "")
