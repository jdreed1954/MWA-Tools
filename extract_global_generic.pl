#!/usr/bin/perl -w
#
# extract_global_generic.pl  PERL script use 
#               data to csv files.
#
...
print tStamp()."Extract Globals ...\n";
my $start = time;
#system("~/bin/perfExtractGlobal.pl ../CSV/$base * > /dev/null");
system("~/bin/perfExtractGlobal.pl ../CSV/$base *");
my $elapsed = time - $start;
print tStamp()."Extract Globals complete.: $elapsed seconds\n\n";
